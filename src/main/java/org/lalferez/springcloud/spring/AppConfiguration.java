package org.lalferez.springcloud.spring;
...
@Configuration
@ComponentScan({ "org.lalferez.springcloud" })
    ...
    public ServletContextInitializer initializer() {
        return new ServletContextInitializer() {
            ...
            public void onStartup(ServletContext servletContext) throws ServletException {
                servletContext.setInitParameter("tapestry.app-package", "org.lalferez.springcloud");
                servletContext.setInitParameter("tapestry.development-modules", "org.lalferez.springcloud.services.DevelopmentModule");
